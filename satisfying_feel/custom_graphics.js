...
(function () {
    ...
    class Miscellanous {
        ...
        getTriBoundingRectImpl(vertices) {
    ...
    class Experimental {
        constructor() { }
        draw(coords, fill_style = "red", stroke_style = "black") {
            ctx.globalAlpha = MODIFIED_PARAMS._GLOBAL_ALPHA;
            if (coords.length === 2) {
                const [x, y] = [...coords];
        ...
        drawPoint(x, y, fill_style = "black", stroke_style = "black") {
            ctx.beginPath();
        ...
        drawLineFromPointGradient(x, y, gradient, x_scale, stroke_style = "black", width = 1) {
        ...
        drawLine(x1, y1, x2, y2, stroke_style = "black", width = 1) {
            ctx.beginPath();
            ctx.moveTo(x1, y1);
            ctx.lineTo(x2, y2);
        ...
        drawDelaunay(delaunayLines, pointList, stroke_style = "black", width = 1) {
    ...
    for (let point in points_Set) {
        _Experimental.draw(points_Set[point], color_list[point % 6]);
    }
