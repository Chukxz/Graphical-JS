...

{
    ...
    function drawTriangle(x1, y1, x2, y2, x3, y3, fill_style = "red", stroke_style = "black") {
        ctx.beginPath();
        ctx.moveTo(x1, y1);
        ctx.lineTo(x2, y2);
        ctx.lineTo(x3, y3);
    ...
    function drawCircle(x, y, r, fill_style = "red", stroke_style = "black") {
        ctx.beginPath();
    ...
    function drawPoint(x, y, fill_style = "black", stroke_style = "black") {
        ctx.beginPath();
    ...
    function drawText(x, y, text, fill_style = "black") {
        ctx.fillStyle = fill_style;
        ctx.lineWidth = 5;
        ctx.fillText(text, x, y);
    }

    function drawLineFromPointGradient(x, y, gradient, x_scale, stroke_style = "black", width = 1) {
        const intercept = y - gradient * x;
        const new_x = x + x_scale;
        const new_y = gradient * new_x + intercept;

        drawLine(x, y, new_x, new_y, stroke_style, width);
    }

    function drawLine(x1, y1, x2, y2, stroke_style = "black", width = 1) {
        ctx.beginPath();
        ctx.moveTo(x1, y1);
        ctx.lineTo(x2, y2);
    ...
    drawTriangle(...tricoords)

    drawPoint(tricoords[0], tricoords[1], 'green');
    drawText(tricoords[0] - 10, tricoords[1] + 10, "A", "green");

    drawPoint(tricoords[2], tricoords[3], 'blue');
    drawText(tricoords[2] - 5, tricoords[3] - 10, "B", "blue");

    drawPoint(tricoords[4], tricoords[5], 'red');
    drawText(tricoords[4] + 10, tricoords[5] + 10, "C", "red");
    ...
    drawPoint(322.40814847482204, 326.3003287107122, "blue", "white");
    drawPoint(372.3684210526316, 290.7894736842104, "pink", "cyan");
}