...
var getRanHex = (size = 1, start = 0) => [...Array(size)].map((elem) => elem = (Math.floor(Math.random() * (16 - start)) + start).toString(16)).join("");

// exclude_col = #000000 (black)
var ranHexCol = (num = 100, start = 0, size = 6) => [...Array(num)].map((elem, index) => elem = "#" + getRanHex(size, start));

console.log(ranHexCol(100, 3))